...
def medicion_grano(p_peso, p_relacion, temp_v, temp_b, offset, m_tcoef, m_slope, m_y0, compact):
    ...
    correcion = spline_curve_point(value, x, y, 64, 0.5)
    print("Correccion por patron: {0:.2f}".format(correcion))

    relacorr = value + correcion
    print("Relacion corregidapor patron: {0:.2f}".format(relacorr))

    relacion = (1024-relacorr-m_y0*2)*4*m_slope/p_peso
    print("Relacion corregida por peso electrolitico: {0:.2f}".format(relacion))
